// LifeBots API - Invite avatar to group
// LSL Script for group_invite command
...
string GROUPUUID = "a2e76fcd-9360-4f6d-a924-000000000000";
string ROLEUUID = "a2e76fcd-9360-4f6d-a924-000000000000";

// Command action
string ACTION = "group_invite";
...
default
{
    state_entry()
    {
        ...
        llOwnerSay("Touch to execute group_invite");
    }
