...
The **Pathfinder Add-On** includes the **Waypoint Navigator** which can be used to create
a sequence of movements and actions for your bot to follow automatically.

Use the **Waypoint Navigator** to automate your Bot's movements and actions to:
