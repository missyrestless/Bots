...
[LifeBots](https://lifebots.cloud) bots via the Unix/Linux command line. These tools are
executed in a terminal using the Bash shell and standard Linux utilities.
